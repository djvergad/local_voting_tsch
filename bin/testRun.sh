...
python -u runSimOneCPU.py --cpuID 1 --numRuns=1 --numCyclesPerRun=100  --numPacketsBurst 25 --burstTimestamp 20 --pkPeriod 16 --otfThreshold 10 --buffer 100 --parents=3 --scheduler none --simDataDir testOutputs | tee tmp.out
